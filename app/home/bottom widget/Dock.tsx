    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={`${className} absolute -top-8 left-1/2 w-fit whitespace-pre rounded-lg border border-white/20 bg-black/60 backdrop-blur-xl px-3 py-1.5 text-xs font-medium text-white shadow-[0_4px_12px_rgba(0,0,0,0.5)]`}
          role="tooltip"
          style={{ x: '-50%' }}
        >
          {children}
