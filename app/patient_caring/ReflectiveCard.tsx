...
const ReflectiveCard: React.FC<ReflectiveCardProps> = ({
  ...
  return (
    <div
      className={`relative rounded-[20px] overflow-hidden bg-[#1a1a1a] shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.1)_inset] isolate font-sans ${className}`}
    ...
    >
      ...
      <div
        className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-yellow-500/30 via-pink-500/20 to-emerald-500/30 z-0 opacity-90 transition-[filter] duration-300"
        style={{
          filter:
      ...
      <div className="relative z-30 h-full w-full flex flex-col text-[var(--text-color,white)] bg-[var(--overlay-color,rgba(255,255,255,0.05))]">
        {children}
      </div>
    </div>
  );
